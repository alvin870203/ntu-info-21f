...
expName = 'animal_detection_txt1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Alvin\\Documents\\~碩班\\Course\\110-1\\心理與神經資訊學_黃從仁\\課程內容\\week02\\單機版實驗程式的設計 (PsychoPy)\\02_Codes\\local\\animal_detection_txt1_lastrun.py',
...
trials = data.TrialHandler(nReps=2, method='random', 
    ...
    trialList=data.importConditions('animal_detection_txt1.csv'),
...
for thisTrial in trials:
    ...
    trialComponents = [ISI, text_2, key_resp_2]
